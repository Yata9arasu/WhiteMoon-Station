...
/mob/living/basic/pet/poppy/death()
	...
	if(safety_inspection)
		...
		if(src.loc in sm_chamber)
			...
			priority_announce("Это сообщение сгенерировано автоматическим сигналом, касающимся стандартов безопасности инженерного отдела на борту [station_name()]. Поскольку инженеры станции не соответствуют стандартам, установленным Центральным Командованием, каждый из них рискует быть принудительно зачисленным на программу повторной оценки в будущем...", "ВНИМАНИЕ: Они Убили Поппи", type = "Priority")
