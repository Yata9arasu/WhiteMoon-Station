...
/datum/round_event/wizard_dice/announce(fake)
	if(prob(80)) //Announcement Optimization
		priority_announce("В этом районе обнаружен магический двадцатигранный артефакт. Пожалуйста, воздержитесь от взаимодействия артефактов Магической Федерации, так как это является грубым нарушением Космического Закона - 404-го пункта.", "Эксперт-маголог Предупреждает")
