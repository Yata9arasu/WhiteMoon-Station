...
/datum/round_event/ion_storm/announce(fake)
	if(prob(announce_chance) || fake)
		priority_announce("Вблизи станции обнаружен ионный шторм. Пожалуйста, проверьте все контролируемое ИИ оборудование на наличие ошибок.", "ВНИМАНИЕ: АНОМАЛИЯ", ANNOUNCER_IONSTORM)
...
/proc/generate_static_ion_law(datum/mind/new_owner)
	...
	for(var/i in GLOB.joined_player_list)
		var/mob/player = get_mob_by_ckey(i)
		if(!player || !player.mind || player.client.inactivity > 10 MINUTES || player.mind == owner) //BLUEMOON ADD рантаймы с нулями без !players
			continue
	...
	var/list/laws = list(	"Вы обязаны всегда врать.",
							...
							"Высшие Представители Nanotrasen недовольны низкой эффективностью работы экипажа. Следовательно, вы должны увеличить эффективность станции.",
