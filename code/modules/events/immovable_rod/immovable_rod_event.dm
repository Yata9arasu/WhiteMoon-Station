...
/datum/round_event/immovable_rod/announce(fake)
	priority_announce("Что это за хуета?!", "Приоритетная Тревога!", ANNOUNCER_IMMOVABLE_ROD) // SPLURT EDIT - ORIGINAL: priority_announce("What the fuck was that?!", "General Alert")
