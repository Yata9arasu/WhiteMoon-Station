...
/datum/round_event/shuttle_loan/announce(fake)
	...
	priority_announce("[situation.announcement_text]", situation.sender)
	if(fake)
		qdel(situation)


/datum/round_event/shuttle_loan/proc/loan_shuttle()
	priority_announce(situation.thanks_msg, "Управление грузовым шаттлом перехвачено: [command_name()].")
