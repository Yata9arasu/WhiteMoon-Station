...
/datum/round_event/carp_migration
	...
	var/fluff_signal = "Неизвестные биологические организмы"
...
/datum/round_event/carp_migration/announce(fake)
	priority_announce("[fluff_signal] были обнаружены вблизи [station_name()]. Пожалуйста, приготовьтесь.", "ВНИМАНИЕ: НЕОПОЗНАННЫЕ ФОРМЫ ЖИЗНИ")
