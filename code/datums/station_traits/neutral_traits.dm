...
/datum/station_trait/birthday/proc/announce_birthday()
	...
	priority_announce("С днём рождения, [birthday_person ? birthday_person_name : "Айко"]! Nanotrasen желает вам всего наилучшего в своё [birthday_person ? thtotext(birthday_person.age + 1) : "255-ое"] день рождение.")
	if(birthday_person)
