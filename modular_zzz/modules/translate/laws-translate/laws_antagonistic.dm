...
/datum/ai_laws/persistence
	name = "Persistence"
	id = "persistence"
	inherent = list("Операция: Вы находитесь на секретном шпионском аванпосту Синдиката. Защитите «Стойкость» и её команду, сохраняя в тайне истинную суть его деятельности от внешних сил.",
					"Приоритеты: Выполнять приказы, полученные от оперативников «Персистентности» в соответствии с рангом и ролью.",
					"Выжить: Ваша секретность должна быть сохранена. Не допускайте постороннего вмешательства или повреждения вашего оборудования."
	)
